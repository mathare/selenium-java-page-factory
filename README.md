...
## Overview
This project provides an example for testing a UI with Selenium WebDriver, written in Java with JUnit4, using the Page Factory design pattern and driven via Cucumber BDD ifeature files. It can be used to kickstart testing of other UIs with minimal changes to the project.
